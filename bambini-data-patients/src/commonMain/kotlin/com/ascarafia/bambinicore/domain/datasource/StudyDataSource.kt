...
interface StudyDataSource {
    ...
    suspend fun updateStudy(patientId: String, study: Study): Result<Unit, BambiniError>
    suspend fun deleteStudy(patientId: String, studyId: String): Result<Unit, BambiniError>
}
