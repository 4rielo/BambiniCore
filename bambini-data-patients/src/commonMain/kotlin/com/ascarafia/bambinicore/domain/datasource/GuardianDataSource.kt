...
interface GuardianDataSource {
    ...
    suspend fun updateGuardian(patientId: String, guardian: Guardian): Result<Unit, BambiniError>
    suspend fun deleteGuardian(patientId: String, guardianId: String): Result<Unit, BambiniError>
}
